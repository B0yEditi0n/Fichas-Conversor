...
const EffectsList = [
    {
        ...
        exclusiveModifiers: [],
        unavaliableModifiers: [10002, 10003, 10004, 10005, 10006, 10007, 100010, 10011, 10012, 10014, 10016, 10017, 10018, 10019, 10020, 10021, 10023, 10024, 10026, 10027, 10030, 10031, 10031, 10032, 10033, 10034, 10036, 10037, 11000, 11003, 11004, 11008, 11009, 11010, 11011, 11012, 11014, 11015, 11018, 11019, 11022, 11023],
    },
    {
        id: 5043,
        name: "- Dispositivo -",
        ...
        exclusiveModifiers: [],
        unavaliableModifiers: [10002, 10003, 10004, 10005, 10006, 10007, 10008, 10009, 10010, 10011, 10012, 10014, 10017, 10018, 10019, 10020, 10021, 10023, 10024, 10026, 10027, 10030, 10031, 10032, 10033, 10034, 10035, 10036, 10037, 11000, 11001, 11003, 11004, 11005, 11006, 11007, 11008, 11009, 11010, 11011, 11012, 11014, 11015, 11018, 11019, 11021, 11022, 11023,],
    },
    {
        id: 5044,
        ...
        exclusiveModifiers: [],
        unavaliableModifiers: [10001, 10002, 10003, 10011, 10012, 10014, 10016, 10018, 10019, 10020, 10021, 10023, 10026, 10027, 10030, 10031, 10037, 11000, 11003, 11005, 11007, 11013, 11015, 11022],
    },
    {
        id: 5045,
    ...
    },
    {
        ...
        affectedTrait: "",
        description: "<p>Este poder permite você adicionar extras e falhas de Dano ao seu bônus de Força. Você pode adicionar extras de Dano para que sejam aplicados nos seus ataques desarmados ou outros poderes que usem seu bônus de Força.</p>"
            + "<p>Você pode adicionar efeitos alternativos baseado nos pontos de poder gastos no seu atributo de Força.",
        exclusiveModifiers: [],
        unavaliableModifiers: [],
    },
    {
        ...
        description: "<b>Efeito de Poder</b>"
            ...
            + "<tr> <td class='LightGoldenCells' colspan='2'><b>Fortitude ou Vontade vs. CD (graduação de Aflição + 10)</b></td> </tr>"
            + "<tr> <td><b>Sucesso</b></td> <td>Sem efeito</td> </tr>"
            + "<tr> <td class='LightGoldenCells'><b>Falha (um grau)</b></td> <td class='LightGoldenCells'>O alvo está tonto, em transe, fadigado, impedido, prejudicado, ou vulnerável (escolha um).</td> </tr>"
            ...
            + "<tr> <td class='LightGoldenCells'><b>Falha (três graus)</b></td> <td class='LightGoldenCells'>O alvo está adormecido, controlado, incapacitado, paralisado, transformado ou desatento (escolha um).</td> </tr>"
            + "</table><br>"
        ...
        exclusiveModifiers: [],
        unavaliableModifiers: [10011, 10012, 10020, 11000, 11015, 11017, 11018],
    },
    {
        id: 5002,
        name: "Alongamento",
        ...
        exclusiveModifiers: [],
        unavaliableModifiers: [10001, 10003, 10008, 10009, 10010, 10011, 10012, 10013, 10015, 10016, 10018, 10020, 10023, 10026, 10030, 10031, 10032, 10035, 10036, 11000, 11001, 11002, 11004, 11006, 11008, 11013, 11015, 11017],
    },
    {
        id: 5003,
        name: "Ambiente ",
        ...
        exclusiveModifiers: [],
        unavaliableModifiers: [10001, 10004, 10005, 10008, 10009, 10010, 10011, 10012, 10013, 10016, 10018, 10020, 10023, 10026, 10030, 10031, 10035, 10036, 11000, 11002, 11004, 11006, 11013, 11017],
    },
    {
        id: 5004,
        name: "Camuflagem",
        ...
        exclusiveModifiers: [],
        unavaliableModifiers: [10003, 10012, 10013, 10018, 10020, 10026, 10030, 10031, 10033, 11000, 11002, 11004, 11006],
    },
    {
        id: 5005,
        name: "Característica",
        ...
        description: "<b>Efeito de Poder</b>"
            ...
            + "</ul>",
        exclusiveModifiers: [],
        unavaliableModifiers: [10012, 10014, 10017, 10020, 10026, 11000],
    },
    {
        id: 5006,
        ...
        exclusiveModifiers: [],
        unavaliableModifiers: [10001, 10003, 10011, 10012, 10018, 10020, 10026, 11000, 11007, 11015, 11017],
    },
    {
        id: 5007,
        name: "Compreender",
        ...
        exclusiveModifiers: [],
        unavaliableModifiers: [10001, 10003, 10004, 10005, 10011, 10012, 10013, 10015, 10018, 10019, 10020, 10026, 10030, 10031, 10034, 10035, 10036, 11000, 11002, 11015],
    },
    {
        id: 5008,
        name: "Comunicação",
        ...
        description: "<b>Efeito de Poder</b>"
            ...
            + "",
        exclusiveModifiers: [],
        unavaliableModifiers: [10001, 10003, 10004, 10005, 10011, 10012, 10013, 10017, 10018, 10019, 10020, 10026, 10030, 10036, 11000, 11001, 11003, 11007, 11015, 11017, 11018],
    },
    {
        id: 5009,
        ...
        description: "<b>Efeito de Poder</b>"
            ...
            + "</ul>",
        exclusiveModifiers: [],
        unavaliableModifiers: [10011, 10012, 10019, 10021, 10023, 10026, 10031, 11003,],
    },
    {
        id: 5010,
        name: "Crescimento",
        ...
        description: "<b>Efeito de Poder</b>"
            ...
            + "</ul>",
        exclusiveModifiers: [],
        unavaliableModifiers: [10019, 10027, 10037, 11003,],
    },
    {
        id: 5011,
        name: "Criar",
        ...
        description: "<b>Efeito de Poder</b>"
            ...
            + "",
        exclusiveModifiers: [],
        unavaliableModifiers: [10014, 10026, 11000,],
    },
    {
        id: 5012,
        name: "Cura",
        ...
        description: "<b>Efeito de Poder</b>"
            ...
            + "",
        exclusiveModifiers: [],
        unavaliableModifiers: [10011, 10012, 10014, 10019, 10021, 10023, 10026, 10027, 10030, 11000, 11003, 11015, 11022],
    },
    {
        id: 5013,
        name: "Dano",
        ...
        description: "<b>Efeito de Poder</b>"
            ...
            + "",
        exclusiveModifiers: [],
        unavaliableModifiers: [10021, 11000, 11015],
    },
    {
        id: 5014,
        name: "Deflexão",
        ...
        description: "<b>Efeito de Poder</b>"
            ...
            + "",
        exclusiveModifiers: [],
        unavaliableModifiers: [10012, 10014, 10021, 10023, 10027,],
    },
    {
        id: 5015,
        name: "Encolhimento",
    ...
    },
    {
        ...
        resistedBy: "Nenhum",
        affectedTrait: "",
        description: "<p>Este poder age como um container para extras que afetam poderes diferetes no personagem ou uma variedade de efeitos. Por exemplo, um personagem que pode fazer disparos a longa distância com qualquer arma pode acrescentar o extra Distância Aumentada. Você deve usar o extra Descritor Variável para mostrar quais efeitos adicionais este extra pode afetar.</p>",
        exclusiveModifiers: [],
        unavaliableModifiers: [],
    },
    {
...
const _PowerOptionsList = [5003, 5004, 5007, 5009, 5020, 5027, 5035];
